...
function setAnnoncesBorder(){
    ...
    if(annonces.length >= 1) annonces[annonces.length-1].style.borderBottom = "none";
    if(annonces.length > 1) for(let index = 0 ; index < annonces.length-1; index ++) annonces[index].style.borderBottom = "grey solid .3px"; 
}
